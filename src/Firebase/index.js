...
export const firebaseRemoveUploadedImage = (
  ...
  const dummy = "https://firebasestorage.googleapis.com/v0/b/snscanteen.appspot.com/Images"
  promise(true);
...
export const firebaseSaveOrder = async (data) => {
  await setDoc(doc(firestore, "Order", `${Date.now()}`), data, {
    merge: true,
  });
};
